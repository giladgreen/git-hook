...
const CLUBS = {
    ...
    "106": "רוקח 121 רמת גן",
    "66": "רוקח 4 תל אביב",
    "56": "האקדמיה לטניס דודי סלע",
}
const CLUB_IDS= Object.keys(CLUBS).join(',');
const DAYS = {
    1: 'ראשון',
    2: 'שני',
    3: 'שלישי',
...
function getPastReservationsSection(reservations) {
    ...
    return `
        <div><u><b>${translations.pastReservationsSummary} (${reservations.length}): ${totalCost} ${translations.shekels} </b></u></div>
